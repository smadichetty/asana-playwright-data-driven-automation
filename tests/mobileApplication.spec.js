...
const testData = require('../test-data/mobileTestData.json');

test.describe('Mobile Application - Data Driven Automation Suite', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    // Wait for Mobile Application project to appear
    await page.waitForSelector('h2:has-text("Mobile Application")', { timeout: 20000 });
  });
  ...
  testData.testCases.forEach((scenario) => {
    ...
    test(scenario.testName, async ({ page }) => {
      ...
      // Click Mobile Application project
